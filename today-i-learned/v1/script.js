...
//Creating  DOM elemenys : Render facts in list 

factsList.innerHTML = "" ;

// Load Data from suparbase
loadFacts();
async function loadFacts(){
   const res = await fetch("https://xvwwgyftvvzupnnazaip.supabase.co/rest/v1/facts", {
      headers: {
       apikey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh2d3dneWZ0dnZ6dXBubmF6YWlwIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODEzMjIyODgsImV4cCI6MTk5Njg5ODI4OH0.dZMYFKeqGMxmhwAQnwvuWxZhlr6jWZQ3RFGBEQUqNlU",
       authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh2d3dneWZ0dnZ6dXBubmF6YWlwIiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODEzMjIyODgsImV4cCI6MTk5Njg5ODI4OH0.dZMYFKeqGMxmhwAQnwvuWxZhlr6jWZQ3RFGBEQUqNlU",
    },
    });  
    const data = await res.json();
    //console.log(data);
   //  const filtedData = data.filter((fact) => fact.category == 'technology');
